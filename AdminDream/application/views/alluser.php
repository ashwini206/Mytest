                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php echo @$rr['promo_code'] ?></td>
                                            <td>
                                              <a href="chart.html"><i class="fa fa-bar-chart-o" style="font-size: 25px;"></i></a>&nbsp;&nbsp;
                     

                                            <a href="chart.html"><i class="fa fa-pencil-square-o" style="font-size: 25px;"></i></a>
